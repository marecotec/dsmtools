...
class GenericToolsSplitByAttributes(object):
    ...
    def getParameterInfo(self):
        ...
        input_feature.value = "D:\Example\GenericToolsSplitByAttributes\ShapefileToSplit.shp"
        ...
        output_directory.value = "D:\Example\GenericToolsSplitByAttributes\Output\/"
    ...
    def execute(self, parameters, messages):
        ...
        for each_attribute in attribute_1_types:
            output_feature = os.path.join(output_directory, str(each_attribute) + ".shp")
